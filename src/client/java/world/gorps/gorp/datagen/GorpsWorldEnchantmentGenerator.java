...
import world.gorps.gorp.enchantment.GorpEnchantments;
import world.gorps.gorp.enchantment.effect.JorpDraftEnchantmentEffect;

import java.util.List;
import java.util.concurrent.CompletableFuture;

public class GorpsWorldEnchantmentGenerator extends FabricDynamicRegistryProvider {
    public GorpsWorldEnchantmentGenerator(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        register(context, GorpEnchantments.JORP_DRAFT,
                Enchantment.enchantment(
                                Enchantment.definition(
                                        context.lookup(Registries.ITEM).getOrThrow(GorpItemTagProvider.JORP_DRAFT_ENCHANTABLE), // The items this enchantment can be applied to
                        ...
                        .withEffect(
                                ...
                                new JorpDraftEnchantmentEffect(LevelBasedValue.perLevel(0.4f, 0.2f))
                        )
        );
        register(context, GorpEnchantments.REPULSION_CURSE,
                Enchantment.enchantment(
                                Enchantment.definition(
